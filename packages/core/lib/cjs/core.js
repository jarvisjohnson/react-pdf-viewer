...
var CanvasLayer = function (_a) {
    ...
    useIsomorphicLayoutEffect(function () {
        ...
        var maxScale = Math.sqrt((MAX_CANVAS_SIZE * outputScale * outputScale) / (viewport.width * viewport.height));
        ...
        canvasEle.style.width = "".concat(roundToDivide(viewport.width / outputScale, y), "px");
        canvasEle.style.height = "".concat(roundToDivide(viewport.height / outputScale, y), "px");
